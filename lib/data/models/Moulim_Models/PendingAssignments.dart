...
class MoulimAssignment {
  bool status;
  List<Data> data;

  MoulimAssignment({this.status, this.data});

  MoulimAssignment.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = new List<Data>();
      json['data'].forEach((v) {
...
Future<MoulimAssignment> fetchMoulimAssignemnt(int id) async {
