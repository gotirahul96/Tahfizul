...
class PendingAssignmentScreen extends StatefulWidget {
  PendingAssignmentScreen({Key key}) : super(key: key);

  @override
  _PendingAssignmentScreenState createState() => _PendingAssignmentScreenState();
}
                          ...
                          child: SingleChildScrollView(
                              child: ConstrainedBox(
                                  ...
                                  child: Column(
                                     ...
                                     child: SpinKitDoubleBounce(
                                   ...
                                   ) : checkstatus != null ? Center(
                                              child: Text(checkstatus,style: AppStyles.blackTextStyle),
                                            ) :    Column(
                                        ...
                                        Padding(
                                          ...
                                          child: Text('PENDING',style: AppStyles.greenTextStyle.copyWith(
                                            color: AppColors.buttonBg,fontSize: 25,fontWeight: FontWeight.w500),),
                                        ),
                                        Text('ASSIGNMENTS',style: AppStyles.greenTextStyle.copyWith(
                                          color: AppColors.appBarColor,fontSize: 25),),
                                          Container(
