...
class WalidainAssignmentDetails extends StatefulWidget {
  WalidainAssignmentDetails({Key key}) : super(key: key);

  @override
  _WalidainAssignmentDetailsState createState() => _WalidainAssignmentDetailsState();
}

class _WalidainAssignmentDetailsState extends State<WalidainAssignmentDetails> {
...
pr.update(
  ...
  Widget build(BuildContext context) {
    ...
    return ModalProgressHUD(
        ...
        child: GestureDetector(
            ...
            child: SafeArea(
                ...
                // backgroundColor: AppColors.talibhenavbar_bg,         
                    ...
                    color: AppColors.darkColor, //change your color here
                    ),),
        ...
        color: assignmentDetails.status == 'Pending' ? AppColors.lightblue :  AppColors.whiteColor,
        child: Container(
          child: Column(
            children: [
                Container(  
                  decoration: BoxDecoration(
                    ...
                    color: assignmentDetails.status == 'Pending' ? AppColors.darkblue : AppColors.darkblue ,
                  ),
                  child: Padding(
                        ...
                        Padding(
                         padding: const EdgeInsets.only(top : 5.0,bottom: 20.0),
                          child: IconButton(
                           ...
                           onPressed: (){_launchURL(assignmentDetails.file);}),
                        ),
                      assignmentDetails.status == 'Pending' ? Container():  Row(
                         mainAxisAlignment: MainAxisAlignment.end,
                          children: [
                            ...
                            onPressed: (){downloadAlert(assignmentDetails.submittedFile,'test');}),
                          ],
                        ),
                      ],
                    ),
